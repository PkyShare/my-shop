<div class="page-footer">
    <div class="page-footer-inner">
        <span class="text-info">&copy 2018 myshop By</span>
        <a target="_blank" href="#">pkyShare &nbsp;|&nbsp;</a>
        <a href="#" target="_blank">1689936851@qq.com</a>
...
<script src="/static/assets/global/plugins/jquery-validation/js/jquery.validate.js"></script>
<script src="/static/assets/global/plugins/jquery-validation/js/additional-methods.js"></script>
<script src="/static/assets/global/plugins/jquery-validation/js/localization/messages_zh.js"></script>
...
<!-- BEGIN APP APLICATION -->
<script src="/static/assets/apps/validate.js" type="text/javascript"></script>
<!-- END APP APLICATION -->
<script>
